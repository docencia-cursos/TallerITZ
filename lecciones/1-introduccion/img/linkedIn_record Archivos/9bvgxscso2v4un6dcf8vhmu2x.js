...
return e.queryURL(n,{params:o,method:"GET",cacheKey:i.cacheKey||`batch_get|${t}|${r.join(",")}`,reload:i.reload,backgroundReload:i.backgroundReload})}updateRecord(e,t,r){const i=e.serializerFor(r.modelName),a={},o=r.adapterOptions||{}
...
delete i.data}return{url:a,options:i}}_queryTunnelRequest(e,t,r){let i,a=e,n=t
const s={headers:{...r.headers},method:n,body:r.body},l=(0,o.get)(this.fastboot,"metadata")
f.default?i=m.default.queryTunnel.queryTunnelRequest(a,s):l.queryTunnelingEnabled&&(i=m.default.queryTunnel.checkAndEncodeLongUrl(a,s))
if(i){({url:a}=i)
const{request:e}=i
n=e.method
r.headers={...r.headers,...e.headers}
r.body=e.body}return{url:a,type:n,options:r}}ajaxOptions(e,t,r){const{url:i,options:a}=this.mungeOptionsForFetch(e,t,r),o=this._queryTunnelRequest(i,t,a)
...
if("GET"===t){const t=(0,n.copy)(r,!0)||{}
t.accept=(0,o.get)(this,"headers.Accept")
const i=this.cachePrefetch.getCache(e,t)
if(i)return i}return"production"===d.default.environment&&f.default?super.ajax(...arguments).catch(this._checkAuthenticationError.bind(this)):super.ajax(...arguments)}shouldReloadAll(){return!0}shouldBackgroundReloadRecord(){return!1}get headers(){return(0,c.default)(this.currentRequestType,this.globalHttpHeaders.getGlobalHeaders())}normalizeErrorResponse(e,t,r){let i
if(r)if(r.status)i=[r]
else if(r.errors)i=Array.isArray(r.errors)?r.errors:[r.errors]
else if("object"==typeof r){var a,o,n,s
r.headers=t
i=[{status:`${e}`,title:"The backend responded with an error",detail:JSON.stringify(r),exceptionClass:null==r||null===(a=r.data)||void 0===a?void 0:a.exceptionClass,serviceErrorCode:null==r||null===(o=r.data)||void 0===o?void 0:o.serviceErrorCode,message:null==r||null===(n=r.data)||void 0===n?void 0:n.message,code:null==r||null===(s=r.data)||void 0===s?void 0:s.code}]}return i||super.normalizeErrorResponse(...arguments)}_checkAuthenticationError(e){const t=(0,o.get)(this,"router.currentRouteName")
if(!this.isLogout(t)&&e.errors&&e.errors.length){const t=parseInt(e.errors[0].status,10),i=e.message,a=/.*CSRF check failed.*/.test(i)&&t===m.httpStatus.S_403_FORBIDDEN
if(t===m.httpStatus.S_401_UNAUTHORIZED){var r;(0,h.clearCSRFTokenCache)()
null===(r=this.getLocationUtil())||void 0===r||r.replace((0,g.getDomainUrl)())}else if(a){f.default&&(document.cookie="JSESSIONID=; path=/; domain=.www.linkedin.com; expires=Thu, 01 Jan 1970 00:00:00 GMT")
const e=(0,b.default)()
...
e.default=m}))
define("voyager-web/controllers/authentication",["exports","@babel/runtime/helpers/esm/initializerDefineProperty","@babel/runtime/helpers/esm/defineProperty","@babel/runtime/helpers/esm/applyDecoratedDescriptor","@babel/runtime/helpers/esm/initializerWarningHelper","@ember/controller","@glimmer/tracking","@ember/service","@ember/application","@ember/object","cache-prefetch/utils/cache-prefetch-config","ember-app-scheduler","ember-cli-pemberly-tracking/utils/user-timing","global-utils/utils/is-browser","global-utils/utils/transition","voyager-web/utils/new-tab-tracker","module-boundary-utils","voyager-web/config/environment"],(function(e,t,r,i,a,o,n,s,l,u,d,c,p,f,m,h,b,g){Object.defineProperty(e,"__esModule",{value:!0})
e._shouldEnableMessagingOverlay=B
e.default=void 0
var y,v,_,w,j,P,O,k,x,M,N,T,E,A,z,R,U,I,S,C,D,L,q
const K={feed:["notifications","mynetwork","jobs"],jobs:["notifications","feed","messaging","mynetwork"],me:["notifications","feed","profile"],mynetwork:["notifications","feed","messaging","jobs"],notifications:["feed","messaging","mynetwork","jobs"],profile:["notifications","feed","messaging","mynetwork","jobs"],"member-analytics":["notifications","feed","profile"]},F=["jobs-search","jobs-collections","jobs.index","jobs.index.index","jobs-search_loading","jobs-search.index","jobs.saved","jobs.applied","search.jobs"],H=["ad-preview.preview","feed.hashtag-feed.present","feed.live-preview","feed.sponsored-update","feed.sales-navigator","news.feed-update-preview",/^onboarding\./,/^inshare\./,"premium.welcome-flow","premium.products","premium.survey",/^premium\.cancellation/,/^premium\.switcher/,/^premium\.redeem-v3/,/^profile-skill-assessments\./,/^video-intro\./,"video-engine.embed","video-engine.live",/^video-engine.go-live\./,"msg-video-call.index",/^job-posting\./,/^trust-verifications\./]
function B(e){if(!(0,b.hasBundle)("msg-overlay"))return!1
const t=e.to?e.to.name:null
for(let e=0;e<H.length;e+=1){const r=H[e],i=r instanceof RegExp&&r.test(t)
if(t===r||i)return!1}return!0}const $="authentication-outlet",G=`${$} nav-hidden`
let V=(y=(0,s.inject)("router"),v=(0,s.inject)("cache-prefetch@cache-prefetch"),_=(0,s.inject)("client-sensor-web@client-sensor"),w=(0,s.inject)("tracking"),j=(0,s.inject)("lix"),P=(0,s.inject)("prefetch"),O=(0,s.inject)("authentication@authenticated-user"),k=(0,s.inject)("global-nav-shared@nav-interaction"),x=(0,s.inject)("s-upsell@detached-upsell-modal"),M=class extends o.default{get multiSendEnabled(){return this.lix.getTreatmentIsEnabled("voyager.web.messaging-multi-send-from-feed")}get showNav(){return this.navInteraction.globalNavIsVisible}get isGuest(){return this.authenticatedUser.isGuestUser}get guestUserHasMID(){return!!this.authenticatedUser.midToken}get outletClass(){return this.showNav?$:G}get isGlobalSearchBarHidden(){const e=this.router.currentRouteName,t=this._previousRoute
return!("authentication.loading"!==e||!F.some((e=>null==t?void 0:t.includes(e))))||F.some((t=>e.includes(t)))}constructor(){super(...arguments);(0,r.default)(this,"queryParams",["chatId","msgOverlay","msgCompose","msgConversationId","msgConferenceId","msgRecipientId","msgControlName"]);(0,t.default)(this,"router",N,this);(0,t.default)(this,"cachePrefetch",T,this);(0,t.default)(this,"clientSensor",E,this);(0,t.default)(this,"tracking",A,this);(0,t.default)(this,"lix",z,this);(0,t.default)(this,"prefetch",R,this);(0,t.default)(this,"authenticatedUser",U,this);(0,t.default)(this,"navInteraction",I,this);(0,t.default)(this,"detachedUpsellModal",S,this);(0,t.default)(this,"searchKeywords",C,this);(0,t.default)(this,"isMessagingOverlayEnabled",D,this);(0,t.default)(this,"targetName",L,this);(0,t.default)(this,"_previousRoute",q,this);(0,r.default)(this,"canCachePrefetch",!0);(0,r.default)(this,"isBrowser",f.default);(0,r.default)(this,"isDevelopmentEnvironment","development"===g.default.environment);(0,r.default)(this,"newTabTracker",void 0)
...
this._chainedRAFs=[]
if(f.default){const e=(0,l.getOwner)(this);(0,h.cleanNewTabParams)(window)
this.newTabTracker=new h.default(e.rootElement,this.tracking)}}routeWillTransition(e){var t
...
if(this.canCachePrefetch&&t){this.canCachePrefetch=!1;(0,c.whenRouteIdle)().then((()=>{const e=t.split(".")[0],r=K[e]
return this.cachePrefetch.fetch(e,d.default,r)}))}}_toggleMessagingOverlay(e){if(!(0,m.isQueryParamsOnly)(e))if(f.default&&B(e)&&!this.isGuest){p.default.addMarker("mark_msg-overlay_overall_start")
p.default.addMarker("mark_msg-overlay_content_download_start")
this.prefetch.prefetchAssets("msg-overlay").then((()=>{if(!this.isDestroying&&!this.showResumeOnboardingBanner){if(!this._trackedOverlayRUMPhases&&p.default.hasMarkerName("mark_msg-overlay_content_download_start")){p.default.addMarker("mark_msg-overlay_content_download_end")
p.default.measureTime("mark_msg-overlay_content_download_phase","mark_msg-overlay_content_download_start","mark_msg-overlay_content_download_end")
p.default.addMarker("mark_msg-overlay_boot_start")
this._trackedOverlayRUMPhases=!0}this.isMessagingOverlayEnabled=!0}})).catch((e=>{this.clientSensor.incrementMetricCounter({groupName:"messaging",metricName:"msg-overlay-bundle-load-failure"})
throw e}))}else this.isMessagingOverlayEnabled=!1}willDestroy(){super.willDestroy()
f.default&&this._chainedRAFs.forEach((e=>window.cancelAnimationFrame(e)))
this.newTabTracker&&this.newTabTracker.destroy()}setSearchKeywords(e){this.searchKeywords=e}handleTransitionToRoute(){this.transitionToRoute.apply(this,[...arguments])}},N=(0,i.default)(M.prototype,"router",[y],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),T=(0,i.default)(M.prototype,"cachePrefetch",[v],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),E=(0,i.default)(M.prototype,"clientSensor",[_],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),A=(0,i.default)(M.prototype,"tracking",[w],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),z=(0,i.default)(M.prototype,"lix",[j],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),R=(0,i.default)(M.prototype,"prefetch",[P],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),U=(0,i.default)(M.prototype,"authenticatedUser",[O],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),I=(0,i.default)(M.prototype,"navInteraction",[k],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),S=(0,i.default)(M.prototype,"detachedUpsellModal",[x],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),C=(0,i.default)(M.prototype,"searchKeywords",[n.tracked],{configurable:!0,enumerable:!0,writable:!0,initializer:function(){return""}}),D=(0,i.default)(M.prototype,"isMessagingOverlayEnabled",[n.tracked],{configurable:!0,enumerable:!0,writable:!0,initializer:function(){return!1}}),L=(0,i.default)(M.prototype,"targetName",[n.tracked],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),q=(0,i.default)(M.prototype,"_previousRoute",[n.tracked],{configurable:!0,enumerable:!0,writable:!0,initializer:function(){return""}}),(0,i.default)(M.prototype,"setSearchKeywords",[u.action],Object.getOwnPropertyDescriptor(M.prototype,"setSearchKeywords"),M.prototype),(0,i.default)(M.prototype,"handleTransitionToRoute",[u.action],Object.getOwnPropertyDescriptor(M.prototype,"handleTransitionToRoute"),M.prototype),M)
e.default=V}))
define("voyager-web/controllers/error",["exports","@babel/runtime/helpers/esm/initializerDefineProperty","@babel/runtime/helpers/esm/defineProperty","@babel/runtime/helpers/esm/applyDecoratedDescriptor","@babel/runtime/helpers/esm/initializerWarningHelper","@ember/object","@ember/controller","voyager-web/config/environment","@glimmer/tracking"],(function(e,t,r,i,a,o,n,s,l){Object.defineProperty(e,"__esModule",{value:!0})
e.default=void 0
var u,d,c
const p="feed.index"
let f=(u=class extends n.default{constructor(){super(...arguments);(0,t.default)(this,"isDev",d,this);(0,t.default)(this,"lastRetriedTransition",c,this)}get willReload(){const{lastRetriedTransition:e}=this
return e&&e.to&&e.to.name===p}get willGoHome(){return this.model.attemptedTransition===this.lastRetriedTransition}retryTransition(e){let t=e
const{lastRetriedTransition:r}=this,i=r&&r.to&&r.to.name
if(i===(t.to&&t.to.name)){i===p&&document.location.reload(!0)
t=this.transitionToRoute("feed")}else t=t.retry()
t.then((()=>{this.lastRetriedTransition=null}))
this.lastRetriedTransition=t}viewProductionVersion(){this.isDev=!1}},d=(0,i.default)(u.prototype,"isDev",[l.tracked],{configurable:!0,enumerable:!0,writable:!0,initializer:function(){return"development"===s.default.environment}}),c=(0,i.default)(u.prototype,"lastRetriedTransition",[l.tracked],{configurable:!0,enumerable:!0,writable:!0,initializer:function(){return null}}),(0,i.default)(u.prototype,"retryTransition",[o.action],Object.getOwnPropertyDescriptor(u.prototype,"retryTransition"),u.prototype),(0,i.default)(u.prototype,"viewProductionVersion",[o.action],Object.getOwnPropertyDescriptor(u.prototype,"viewProductionVersion"),u.prototype),u)
e.default=f}))
...
e.prototype.toString=function(){return`${this.string}`}}var n={name:"override-safestring",initialize:o}
e.default=n}))
...
this.route("newsletter-new",{path:"/newsletter/new"})}))}))
e.default=r}))
...
this.route("index",{path:"/:eventId"},(function(){this.route("home",{path:"/"},(function(){this.route("shares",(function(){this.mount("me-ca",{as:"event-shares-ca",path:"/ca",resetNamespace:!0})
...
this.mount("groups-organizer",{path:"/manage",resetNamespace:!0})
...
this.route("demographics-visibility")
...
e.default=r}))
define("voyager-web/route-maps/organization-content-suggestions",["exports","ember-engines/routes"],(function(e,t){Object.defineProperty(e,"__esModule",{value:!0})
e.default=void 0
var r=(0,t.default)((function(){this.route("content-suggestions",{path:"/"},(function(){this.route("company-news")
...
this.route("overlay-about",{path:"/overlay/about-this-profile"})}var s=(0,t.default)((function(){this.route("common",{path:"/:vanityName"},(function(){this.route("profile",{path:"/"},n)
...
e.default=void 0
var r=(0,t.default)((function(){this.route("identity-start",{path:"/identity/:verificationType/start"})
...
this.route("index",{path:"/*"})}))
e.default=r}))
define("voyager-web/route-maps/video-intro",["exports","ember-engines/routes"],(function(e,t){Object.defineProperty(e,"__esModule",{value:!0})
e.default=void 0
var r=(0,t.default)((function(){this.route("start")
this.route("complete")
this.route("index",{path:"/:hiring_project_urn"})}))
e.default=r}))
...
e.default=r}))
define("voyager-web/router",["exports","@babel/runtime/helpers/esm/initializerDefineProperty","@babel/runtime/helpers/esm/defineProperty","@babel/runtime/helpers/esm/applyDecoratedDescriptor","@babel/runtime/helpers/esm/initializerWarningHelper","@ember/object","global-utils/utils/routing","@ember/service","ember-app-scheduler","@ember/routing/router","@ember/runloop","global-utils/utils/is-browser","voyager-web/config/environment","global-utils/utils/accept-invite-without-login","global-utils/utils/group-chat-link-routing-helper","global-utils/utils/titan-route-map","global-utils/utils/validate-msg-deeplinks","voyager-web/utils/url-urn-validator","voyager-web/utils/bigpipe-degradation-detector","ember-cli-pemberly-lix/router","module-boundary-utils/-private/is-isolated-build","voyager-web/hacks/router-setup-time","ember-cli-pemberly-tracking/utils/setup-route-tracking"],(function(e,t,r,i,a,o,n,s,l,u,d,c,p,f,m,h,b,g,y,v,_,w,j){Object.defineProperty(e,"__esModule",{value:!0})
...
for(let a=0;a<t.length;++a){const n=t[a],s=G(e,n)
let l
if(r)if(s&&s in r){const e=0===n.indexOf(s)?n.substr(s.length+1):n
l=(0,o.get)(r[s],e)}else l=(0,o.get)(r,n)
i+=`::${n}:${l}`}return e+i.replace($,"-")}
e.default=void 0
var P,O,k,x,M,N,T,E,A,z,R,U,I,S,C,D,L,q,K,F
const H=["authentication"]
let B=(P=(0,s.inject)("router"),O=(0,s.inject)("authentication@authenticated-user"),k=(0,s.inject)("client-sensor-web@client-sensor"),x=(0,s.inject)("global-nav-shared@badge"),M=(0,s.inject)("global-nav-shared@nav-interaction"),N=(0,s.inject)("html-document-title@document-title-poller"),T=(0,s.inject)("tracking"),E=(0,s.inject)("global-services@page-key-history"),A=(0,s.inject)("msg-overlay-manager@msg-overlay-manager"),(0,v.engineLix)(z=(0,w.default)(z=(R=class extends u.default{constructor(){super(...arguments);(0,r.default)(this,"location",p.default.locationType);(0,r.default)(this,"rootURL",p.default.routerRootURL);(0,r.default)(this,"didRunBigPipeDegradationSensor",!1);(0,t.default)(this,"router",U,this);(0,t.default)(this,"authenticatedUser",I,this);(0,t.default)(this,"clientSensor",S,this);(0,t.default)(this,"badgeService",C,this);(0,t.default)(this,"navInteraction",D,this);(0,t.default)(this,"documentService",L,this);(0,t.default)(this,"tracking",q,this);(0,t.default)(this,"pageKeyHistory",K,this);(0,t.default)(this,"msgOverlayService",F,this);(0,j.setupRouteTracking)(this);(0,l.setupRouter)(this.router)
...
super.willDestroy(...arguments);(0,j.teardownRouteTracking)(this)
this.pageKeyHistory.clear()}},U=(0,i.default)(R.prototype,"router",[P],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),I=(0,i.default)(R.prototype,"authenticatedUser",[O],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),S=(0,i.default)(R.prototype,"clientSensor",[k],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),C=(0,i.default)(R.prototype,"badgeService",[x],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),D=(0,i.default)(R.prototype,"navInteraction",[M],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),L=(0,i.default)(R.prototype,"documentService",[N],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),q=(0,i.default)(R.prototype,"tracking",[T],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),K=(0,i.default)(R.prototype,"pageKeyHistory",[E],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),F=(0,i.default)(R.prototype,"msgOverlayService",[A],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),R))||z)||z)
e.default=B
const $=/\./g
function G(e,t){const r=e.split(".")
let i=""
for(let e=0;e<r.length;e++){const a=r.slice(0,e+1).join(".")
if(0!==t.indexOf(a))break
i=a}return i}B.map((function(){this.route("authentication",{path:"/",resetNamespace:!0},(function(){(0,_.isIsolatedBuild)()&&this.route("aide",{resetNamespace:!0})
...
this.mount("video-intro",{as:"video-intro",path:"/jobs/video-intro/:hiring_project_urn",resetNamespace:!0})
...
this.mount("article-editor",{as:"article-editor",path:"/article-editor",resetNamespace:!0})
...
this.lix.getTreatmentIsEnabled("voyager.web.feed-disable-scroll-top-on-exit")||window.addEventListener("beforeunload",Z)
document.addEventListener("artdeco-icons-loaded",X)
document.addEventListener("DOMContentLoaded",J)}this.router.on("didTransition",(()=>{this.setGlobalAlertVisibility(this.router.currentRoute.queryParams)}))}willDestroy(){super.willDestroy()
if(f.default){this.lix.getTreatmentIsEnabled("voyager.web.feed-disable-scroll-top-on-exit")||window.removeEventListener("beforeunload",Z)
document.removeEventListener("artdeco-icons-loaded",X)
document.removeEventListener("DOMContentLoaded",J)}}model(e,t){const r={}
if(f.default){const e=this.store.queryURL(`/${m.default.namespace}/voyagerGlobalAlerts`,{cacheKey:"route-common-global-alert-collection",params:{q:"findAlerts",alertWithActions:!0,adHocAlerts:!0}})
t.then((()=>{b.default.hash({alerts:e}).then((e=>{let{alerts:t}=e
this._setupAlerts(r,t)}))}))}return r}setupController(e,t){super.setupController(e,t)
e.isLinkedInEmployee=this.lix.getTreatmentIsEnabled("voyager.client.staff")
e.isProfileGeneratedSuggestionsEnabled=this.lix.getTreatmentIsEnabled("voyager.web.premium-profile-generated-suggestions")}updateFavicon(e){const t=e?"badged":"default"
...
i!==a&&this.persistentToastManager.clear()}_setupAlerts(e,t){const r=t&&(0,c.get)(t,"elements"),i=r&&[...r]||[]
...
return!0}loading(){return!this.fastbootBpr.isSSRPath}},I=(0,i.default)(U.prototype,"store",[j],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),S=(0,i.default)(U.prototype,"authenticatedUser",[P],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),C=(0,i.default)(U.prototype,"forceLogout",[O],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),D=(0,i.default)(U.prototype,"badgeService",[k],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),L=(0,i.default)(U.prototype,"tracking",[x],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),q=(0,i.default)(U.prototype,"lix",[M],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),K=(0,i.default)(U.prototype,"fastbootBpr",[N],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),F=(0,i.default)(U.prototype,"router",[T],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),H=(0,i.default)(U.prototype,"pemTracking",[E],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),B=(0,i.default)(U.prototype,"persistentToastManager",[A],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),$=(0,i.default)(U.prototype,"tagManager",[z],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),G=(0,i.default)(U.prototype,"registerTagManager",[R],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),(0,i.default)(U.prototype,"didTransition",[c.action],Object.getOwnPropertyDescriptor(U.prototype,"didTransition"),U.prototype),(0,i.default)(U.prototype,"error",[c.action],Object.getOwnPropertyDescriptor(U.prototype,"error"),U.prototype),(0,i.default)(U.prototype,"loading",[c.action],Object.getOwnPropertyDescriptor(U.prototype,"loading"),U.prototype),U)
e.default=ee}))
define("voyager-web/routes/authentication",["exports","@babel/runtime/helpers/esm/initializerDefineProperty","@babel/runtime/helpers/esm/defineProperty","@babel/runtime/helpers/esm/applyDecoratedDescriptor","@babel/runtime/helpers/esm/initializerWarningHelper","@ember/service","@ember/object","@ember/routing/route","nt-requests/requests/cards","global-utils/utils/is-browser","voyager-web/config/environment","global-utils/utils/get-ie-version","rsvp","global-utils/utils/url","takeover/utils/constants","@linkedin/ember-pem/utils/degradation-tracking-metadata","ember-lifeline"],(function(e,t,r,i,a,o,n,s,l,u,d,c,p,f,m,h,b){Object.defineProperty(e,"__esModule",{value:!0})
e.default=void 0
var g,y,v,_,w,j,P,O,k,x,M,N,T,E,A,z,R,U,I,S,C,D,L,q,K,F,H,B,$,G,V,W,Q,Y,Z,J,X
let ee=(g=(0,o.inject)("authentication@authenticated-user"),y=(0,o.inject)("global-nav@nav"),v=(0,o.inject)("global-nav-shared@badge"),_=(0,o.inject)("date"),w=(0,o.inject)("gdpr-notice@gdpr-notice"),j=(0,o.inject)("profile-services@identity-store"),P=(0,o.inject)("store"),O=(0,o.inject)("internal-logger"),k=(0,o.inject)("i18n"),x=(0,o.inject)("jet"),M=(0,o.inject)("lix"),N=(0,o.inject)("prefetch"),T=(0,o.inject)("router"),E=(0,o.inject)("global-services@router-scroll"),A=(0,o.inject)("global-services@session"),z=(0,o.inject)("tracking"),R=(0,o.inject)("global-services@window"),U=(0,o.inject)("left-panel@left-panel-survey"),I=class extends s.default{constructor(){super(...arguments);(0,t.default)(this,"authenticatedUser",S,this);(0,t.default)(this,"nav",C,this);(0,t.default)(this,"badge",D,this);(0,t.default)(this,"date",L,this);(0,t.default)(this,"gdprNotice",q,this);(0,t.default)(this,"identityStore",K,this);(0,t.default)(this,"store",F,this);(0,t.default)(this,"internalLogger",H,this);(0,t.default)(this,"i18n",B,this);(0,t.default)(this,"jet",$,this);(0,t.default)(this,"lix",G,this);(0,t.default)(this,"prefetch",V,this);(0,t.default)(this,"router",W,this);(0,t.default)(this,"routerScroll",Q,this);(0,t.default)(this,"session",Y,this);(0,t.default)(this,"tracking",Z,this);(0,t.default)(this,"windowService",J,this);(0,t.default)(this,"leftPanelSurvey",X,this);(0,r.default)(this,"feedModuleKey","home-feed:desktop");(0,r.default)(this,"targetName",void 0);(0,r.default)(this,"shouldTransitionToOnboarding",void 0)
...
this.targetName=(null===(t=e.to)||void 0===t?void 0:t.name)??null
if(this.shouldTransitionToOnboarding&&(null===(r=e.to)||void 0===r?void 0:r.name)===m.TAKEOVER_ROUTE_NAME_FEED){this.shouldTransitionToOnboarding=!1;(0,b.runTask)(this,(()=>{this.router.transitionTo("onboarding.start")}),2e3)}}))
if(u.default&&this.lix.getTreatmentIsEnabled("voyager.client.staff")){this.errorHandler=this._handleError.bind(this)
...
const t=(0,l.buildCardsPrefetchConfig)()
this.prefetch.prefetchData([t],"auth-notifications")
this.leftPanelSurvey.initializeSurveyClient()}return(0,p.resolve)()}model(){if(this.authenticatedUser.isGuestUser)return(0,p.resolve)()
if(this.lix.getTreatmentIsEnabled("voyager.infra.web.enableChameleon")){const e=this.store.adapterFor("-ember-m3").ajax(`/${d.default.namespace}/voyagerSegmentsDashChameleonConfig`,"GET")
if(u.default){const t=this.date.now()
e.then((e=>{const r=this.i18n.injectCustomizationToMessageCache(e.data.elements.map((e=>({...e.data,lix:{treatment:e.lixTreatment,testKey:e.lixKey,trackingInfo:e.lixTracking},parentLix:e.parentLixKey?{treatment:e.lixTreatment,testKey:e.parentLixKey,trackingInfo:e.parentLixTracking}:void 0}))))||[]
this.tracking.fireTrackingPayload("ChameleonConfigLoadEvent",{configCount:e.data.elements.length,failedConfigs:r.map((e=>e.lix.trackingInfo.experimentId)),processingDuration:this.date.now()-t})}))}}return this.fetchMemberData()}setReactivationFeatures(){const e=(0,f.addQueryParam)(`/${d.default.namespace}/premium/featureAccess`,"name","reactivationFeaturesEligible")
return this.store.findRecord("com.linkedin.voyager.premium.FeatureAccess","PREMIUM_FEATURE_ACCESS",{adapterOptions:{url:e}}).then((e=>{const{reactivationFeaturesEligible:t,premiumFreeTrialEligible:r}=(0,n.getProperties)(e,"reactivationFeaturesEligible","premiumFreeTrialEligible")
...
return(0,p.hashSettled)(e).then((e=>{const{me:t,takeovers:r}=e
if("rejected"===t.state)throw t.reason
"rejected"===r.state&&this.jet.logError(r.reason,["takeover-error"],!1)
const i=this.authenticatedUser.setAuthenticatedUser("fulfilled"===t.state?t.value:void 0)
u.default&&this.identityStore.reloadVersionTag()
const a="fulfilled"===r.state?r.value??{}:{}
this.shouldTransitionToOnboarding=(0,n.get)(a,"elements.0.launchpadCards.0.cardType")===m.TAKEOVER_TYPE.ONBOARDING
return{user:i,takeovers:(0,n.get)(a,"elements")}}))}prepareMemberData(){const{store:e}=this,t=e.findRecord("com.linkedin.voyager.common.Me",0,{adapterOptions:{url:`/${d.default.namespace}/me`}}),r=e.queryURL("voyagerLaunchpadDashLaunchpadViews",{adapterOptions:{degradations:[new h.default("voyager-launchpad-views","failed-fetching-launchpad-views",{productName:m.TAKEOVER_PEM_PRODUCT_NAME})],degradedEntityIDsToRemove:[]},reload:!0,params:{q:"context",launchpadContext:"TAKEOVER",recipe:"com.linkedin.voyager.dash.deco.launchpad.LaunchpadView"}})
this.gdprNotice.loadPsettings()
return{me:t,takeovers:r}}setupController(e){super.setupController(...arguments)
if(u.default){const e=document.querySelector(".initial-load-animation")
e&&e.classList.add("fade-load")}e.targetName=this.targetName}activate(){if(u.default){let e=document.head.querySelector("meta[name=referrer]")
const t=(0,c.default)(window.navigator.userAgent)
if(!e&&t&&t>=11&&t<12){e=document.createElement("meta")
e.setAttribute("name","referrer")
e.setAttribute("content","origin")
document.head.appendChild(e)}}}fieldChanged(e,t){(0,n.set)(this.controllerFor("authentication"),e,t)}_handleError(e){this.internalLogger.log(e.toString(),["error-js"])}_handleRejection(e){let{reason:t}=e
this.internalLogger.log({reason:t},["error-js"])}},S=(0,i.default)(I.prototype,"authenticatedUser",[g],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),C=(0,i.default)(I.prototype,"nav",[y],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),D=(0,i.default)(I.prototype,"badge",[v],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),L=(0,i.default)(I.prototype,"date",[_],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),q=(0,i.default)(I.prototype,"gdprNotice",[w],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),K=(0,i.default)(I.prototype,"identityStore",[j],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),F=(0,i.default)(I.prototype,"store",[P],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),H=(0,i.default)(I.prototype,"internalLogger",[O],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),B=(0,i.default)(I.prototype,"i18n",[k],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),$=(0,i.default)(I.prototype,"jet",[x],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),G=(0,i.default)(I.prototype,"lix",[M],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),V=(0,i.default)(I.prototype,"prefetch",[N],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),W=(0,i.default)(I.prototype,"router",[T],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),Q=(0,i.default)(I.prototype,"routerScroll",[E],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),Y=(0,i.default)(I.prototype,"session",[A],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),Z=(0,i.default)(I.prototype,"tracking",[z],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),J=(0,i.default)(I.prototype,"windowService",[R],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),X=(0,i.default)(I.prototype,"leftPanelSurvey",[U],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),(0,i.default)(I.prototype,"fieldChanged",[n.action],Object.getOwnPropertyDescriptor(I.prototype,"fieldChanged"),I.prototype),I)
e.default=ee}))
...
e.default=d}))
define("voyager-web/routes/logout",["exports","@babel/runtime/helpers/esm/initializerDefineProperty","@babel/runtime/helpers/esm/defineProperty","@babel/runtime/helpers/esm/applyDecoratedDescriptor","@babel/runtime/helpers/esm/initializerWarningHelper","@ember/object","@ember-decorators/object","@ember/service","ember","@ember/routing/route","@ember/runloop","global-utils/utils/is-browser","voyager-web/config/environment","global-utils/utils/get-csrf-token","global-utils/utils/get-location","global-utils/utils/url","rsvp","ember-lifeline"],(function(e,t,r,i,a,o,n,s,l,u,d,c,p,f,m,h,b,g){Object.defineProperty(e,"__esModule",{value:!0})
e.default=void 0
var y,v,_,w,j,P,O,k
let x=(y=(0,s.inject)("global-services@local-storage"),v=(0,s.inject)("tracking"),_=(0,s.inject)("authentication@force-logout"),w=(0,n.on)("deactivate"),j=class extends u.default{constructor(){super(...arguments);(0,r.default)(this,"pageKey","flagship3_logout");(0,t.default)(this,"localStorage",P,this);(0,t.default)(this,"tracking",O,this);(0,t.default)(this,"forceLogout",k,this);(0,r.default)(this,"templateName","extended@logout")}beforeModel(e){return this._handleWebPushCleanUp().then((()=>super.beforeModel(e)))}model(){if(c.default){const t=(0,f.default)()
...
if(!l.default.testing){var e
null===(e=(0,m.default)())||void 0===e||e.replace(r)
return{}}return{url:r}}}_handleWebPushCleanUp(){let e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:c.default,t=arguments.length>1&&void 0!==arguments[1]?arguments[1]:window,r=arguments.length>2&&void 0!==arguments[2]?arguments[2]:800
...
const a=new b.Promise((t=>{i=(0,g.runTask)(e,(()=>{t("promise timed out")}),r)})),o=t.then((t=>{i&&(0,g.cancelTask)(e,i)
return t})).catch((t=>{i&&(0,g.cancelTask)(e,i)
throw t}))
return(0,b.race)([o,a])}(this,t.navigator.serviceWorker.getRegistration().then((e=>e&&e.pushManager.getSubscription())).then((e=>e&&e.unsubscribe())).catch((e=>{console.error("Error while unsubscribing from web push",e)})),r)}return b.Promise.resolve()}handlePostLogout(e){const t=(0,m.default)()
if("userLoggedOut"===e.data&&e.origin===t.origin){c.default&&window.navigator.credentials&&window.navigator.credentials.requireUserMediation&&window.navigator.credentials.requireUserMediation()
const e=h.default.getDomainUrl()
t.href=`${e}${p.default.routerRootURL}`}}cleanUpLogout(){if(c.default){(0,f.clearCSRFTokenCache)()
window.removeEventListener("message",this._messageListener)}}didTransition(){if(c.default){this._messageListener=(0,d.bind)(this,this.handlePostLogout)
window.addEventListener("message",this._messageListener)}}},P=(0,i.default)(j.prototype,"localStorage",[y],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),O=(0,i.default)(j.prototype,"tracking",[v],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),k=(0,i.default)(j.prototype,"forceLogout",[_],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),(0,i.default)(j.prototype,"cleanUpLogout",[w],Object.getOwnPropertyDescriptor(j.prototype,"cleanUpLogout"),j.prototype),(0,i.default)(j.prototype,"didTransition",[o.action],Object.getOwnPropertyDescriptor(j.prototype,"didTransition"),j.prototype),j)
e.default=x}))
...
Object.defineProperty(e,"default",{enumerable:!0,get:function(){return t.default}})}))
define("voyager-web/services/m3-schema",["exports","ember","ember-cli-pemberly-m3","voyager-web/utils/static-schema","voyager-web/config/environment","rsvp","deco-recipes/recipes","@ember/object/promise-proxy-mixin","dash-interop-helper/utils/get-graphql-value-with-dash-fallback"],(function(e,t,r,i,a,o,n,s,l){Object.defineProperty(e,"__esModule",{value:!0})
e.computeAttributes=d
e.default=void 0
const u=Object.freeze((0,r.normalizeKeys)(i.default))
function d(e){return e.map((e=>"*"===e[0]?e.substring(1):e))}class c extends r.PemberlyM3Schema{init(){super.init(...arguments)
this.models=Object.create(u)
this.enableMergedModelsForGraphQL=!0}computeAttributes(e){return d(e)}computeAttributeReference(e,r,i,a){t.default.testing&&(0,l.devTimeCheckThrowForInterop)(e,i)
return super.computeAttributeReference(e,r,i,a)}fetchMicroSchema(e){if(this.isMicroSchemaRegistered(e))return(0,o.resolve)()
const t=`/${a.default.namespace}/deco/schema?decorationId=${n.default[e]}`
return this.store.adapterFor("-ember-m3").ajax(t).then((t=>this.registerMicroSchema(e,t)))}setAttribute(e,t,r,i){const a=s.default.detect(r)?r.content:r
return super.setAttribute(e,t,a,i)}useNativeProperties(){return!0}}e.default=c}))
...
Object.defineProperty(e,"default",{enumerable:!0,get:function(){return t.default}})}))
define("voyager-web/services/prefetch",["exports","@babel/runtime/helpers/esm/initializerDefineProperty","@babel/runtime/helpers/esm/defineProperty","@babel/runtime/helpers/esm/applyDecoratedDescriptor","@babel/runtime/helpers/esm/initializerWarningHelper","ember","@ember/object","@ember/service","ember-cli-pemberly-tracking/utils/user-timing","voyager-web/utils/prefetch-history","voyager-web/utils/prefetch-constants","ember-cli-pemberly-tracking/utils/uuid","ember-app-scheduler","rsvp","@ember/runloop","@ember/utils","module-boundary-utils","ember-lifeline","global-utils/utils/logger","search-utils/utils/constants"],(function(e,t,r,i,a,o,n,s,l,u,d,c,p,f,m,h,b,g,y,v){Object.defineProperty(e,"__esModule",{value:!0})
e.default=void 0
var _,w,j,P,O,k,x,M,N,T,E,A,z
function R(e,t,r){l.default.addMarker(`mark_ipf_${e}-${t}_${r}`)}const U=Symbol("Prefetch flag symbol")
let I=(_=(0,s.inject)("router"),w=(0,s.inject)("asset-loader"),j=(0,s.inject)("store"),P=(0,s.inject)("tracking"),O=(0,s.inject)("@linkedin/ember-restli-graphql@graphql"),k=(0,s.inject)("jet"),x=class e extends s.default{constructor(){super(...arguments);(0,t.default)(this,"router",M,this);(0,t.default)(this,"assetLoader",N,this);(0,t.default)(this,"store",T,this);(0,t.default)(this,"tracking",E,this);(0,t.default)(this,"graphql",A,this);(0,t.default)(this,"jet",z,this);(0,r.default)(this,"prefetchedBundles",{});(0,r.default)(this,"historyLength",2);(0,r.default)(this,"currentPageId",(0,c.default)());(0,r.default)(this,"previousPageId",null);(0,r.default)(this,"isPrefetchingAssetsEnabled",!1);(0,r.default)(this,"isTransitioning",!1);(0,r.default)(this,"_loadBundleRunTaskTimer",[])
this.history=new u.default(this.currentPageId,this.historyLength)
this.router.on("routeWillChange",this._handleRouteWillChange.bind(this))
this.router.on("routeDidChange",this._handleRouteDidChange.bind(this))}prefetchData(e){let t=arguments.length>1&&void 0!==arguments[1]?arguments[1]:"unknown";(0,p.whenRouteIdle)().then((()=>{let r=e.map((e=>{const{routeName:r,request:i,isGraphQL:a}=e,o=this.router.currentRouteName
if(o&&o.indexOf(r)>-1)return null
let s,l
if(a){const{query:e,variables:t,options:a}=i[0]
l=a
s=this.graphql.executeQuery(e,t,l).catch((e=>{const t=e&&(0,n.get)(e,"errors.0.extensions.status"),i=t&&parseInt(t,10)
if("GraphQLQueryError"===(null==e?void 0:e.name)&&"search.results"===r){const t=[v.JET_TAGS.CLUSTER_PREFETCH_RESULTS,`query: ${i}`]
t.push(`GraphQL errors: ${JSON.stringify(e.errors)}`);(0,y.errorLogger)(this.jet,`Error prefetching data ${t[0]}`,e,t,{shouldRethrow:!1})
return{}}throw e}))}else{const e=i[0]
l={...i[1]}
l[U]=!0
s=this.store.queryURL(e,l).catch((e=>{const t=e&&(0,n.get)(e,"errors.firstObject.status"),i=t&&parseInt(t,10)
if("search.results"===r){var a,o,s
const t=[v.JET_TAGS.CLUSTER_PREFETCH_RESULTS,`query: ${i}`]
t.push(`Dash API request errors: ${JSON.stringify(e.errors)}`);(0,y.errorLogger)(this.jet,`Error prefetching data ${t[0]}`,e,t,{callTreeId:null==e||null===(a=e.errors)||void 0===a||null===(o=a[0])||void 0===o||null===(s=o.meta)||void 0===s?void 0:s.callTreeId,shouldRethrow:!1})
return{}}throw e}))}const{cacheKey:u,discardTimeout:d}=l
s.then((e=>{this._handlePrefetchComplete(e,u,d)}))
this._onM3RequestPrefetchStart(u,t)
return s}))
r=r.filter((e=>null!==e))
return(0,f.all)(r)}))}prefetchAssets(e){let t=arguments.length>1&&void 0!==arguments[1]?arguments[1]:"dummy_pageKey",r=arguments.length>2&&void 0!==arguments[2]?arguments[2]:"unknown"
return(0,b.hasBundle)(e)&&!this.prefetchedBundles[e]?(0,p.whenRouteIdle)().then((()=>this._loadBundleHelper(e,t,r))):(0,f.resolve)()}prefetchAssetsWithRouteName(t){const r=e.getMappedParametersFromRouteName(t)
if((0,h.isPresent)(r)){const{bundleMetadata:e}=r,i=t.split(".index")[0]
Object.entries(e).forEach((e=>{let[t,r]=e;(0,b.hasBundle)(t)&&!this.prefetchedBundles[t]&&(0,p.whenRouteIdle)().then((()=>{const e=`INFRA-${i}-${t}`,a=(0,g.runTask)(this,(()=>{this._loadBundleHelper(t,r,e)}),2e3)
...
null!==i&&i.completed&&i.sourcePageId===a&&R("consume",d.PREFETCH_EVENT_TYPE.M3_REQUEST,i.scenario)}enablePrefetchingAssets(){this.isPrefetchingAssetsEnabled=!0}_loadBundleHelper(e,t,r){return this.assetLoader.loadBundle(e).then((()=>{this._onAssetsPrefetchStart(e,t,r)
this.prefetchedBundles[e]=!0})).catch((e=>{if("BundleLoadError"!==e.name)throw e}))}_handleRouteWillChange(){this._loadBundleRunTaskTimer.forEach((e=>{(0,g.cancelTask)(this,e)}))
...
null!==n&&n.sourcePageId===this.previousPageId&&R("consume",d.PREFETCH_EVENT_TYPE.ASSETS,n.scenario)
...
R("start",d.PREFETCH_EVENT_TYPE.ASSETS,r)}_onM3RequestPrefetchStart(e,t){this.history.onM3RequestPrefetchStart(e,t)
R("start",d.PREFETCH_EVENT_TYPE.M3_REQUEST,t)}_onM3RequestPrefetchComplete(e){this.history.onM3RequestPrefetchComplete(e)}_handlePrefetchComplete(e,t,r){this._onM3RequestPrefetchComplete(t)
void 0===r||o.default.testing||(0,m.later)((()=>e.unloadRecord()),r)}_updatePageId(){this.previousPageId=this.currentPageId
this.currentPageId=(0,c.default)()}static getMappedParametersFromRouteName(e){return d.ROUTE_TO_ASSET_PARAM_MAP[e]}},M=(0,i.default)(x.prototype,"router",[_],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),N=(0,i.default)(x.prototype,"assetLoader",[w],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),T=(0,i.default)(x.prototype,"store",[j],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),E=(0,i.default)(x.prototype,"tracking",[P],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),A=(0,i.default)(x.prototype,"graphql",[O],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),z=(0,i.default)(x.prototype,"jet",[k],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),x)
e.default=I}))
...
Object.defineProperty(e,"default",{enumerable:!0,get:function(){return t.default}})}))
define("voyager-web/services/unified-event-handler",["exports","ember-singularity/services/unified-event-handler"],(function(e,t){Object.defineProperty(e,"__esModule",{value:!0})
Object.defineProperty(e,"default",{enumerable:!0,get:function(){return t.default}})}))
...
e.default=void 0
var r=(0,t.createTemplateFactory)({id:"ojcW6fSy",block:'[[[8,[39,0],null,null,null]],[],false,["not-found@not-found"]]',moduleName:"voyager-web/templates/404.hbs",isStrictMode:!1})
e.default=r}))
...
e.default=void 0
var r=(0,t.createTemplateFactory)({id:"bbDQbV1P",block:"[[],[],false,[]]",moduleName:"voyager-web/templates/authentication/loading.hbs",isStrictMode:!1})
e.default=r}))
...
e.default=void 0
var r=(0,t.createTemplateFactory)({id:"6T4fdlN5",block:'[[[18,1,null]],["&default"],false,["yield"]]',moduleName:"voyager-web/templates/components/sortable-objects.hbs",isStrictMode:!1})
e.default=r}))
...
e.default=void 0
var r=(0,t.createTemplateFactory)({id:"hE9IO26s",block:'[[[10,"iframe"],[15,"src",[30,0,["model","url"]]],[14,0,"authentication-iframe"],[15,"title",[28,[37,0],["iframe_title","voyager-web/templates/logout"],null]],[12],[13]],[],false,["t"]]',moduleName:"voyager-web/templates/logout.hbs",isStrictMode:!1})
e.default=r}))
...
"undefined"==typeof FastBoot&&(runningTests||require("voyager-web/app").default.create({locale:"en_US",rumConfig:{pageKeyPrefix:"d_","beacon-service":"tracking","beacon-url":"/li/track","event-name":"RealUserMonitoringEvent","enable-cdn-tracking":!0,"enable-pop-tracking":!0,"user-timing-mark-enabled":!0,"web-vitals-enabled":!0,"enable-memory-measurement":!0},name:"voyager-web",version:"0.0.0-productspec+929572bd"}))
