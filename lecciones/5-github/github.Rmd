...
## Objetivo
Al finalizar la lección, conoceremos parte del funcionamiento de GitHub y podremos enlazar .....
...
- Desde GitHub realiza un cambio a reverse-complement.py
...
- Desde tu repositorio local modifica el archivo reverse-complement.py
